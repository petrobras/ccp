...
The code uses
[CoolProp](http://www.coolprop.org/) [@coolprop] and
[REFPROP](https://www.nist.gov/srd/refprop) [@refprop]
...
imp.disch.T_plot()
```
You can get more details by reading the [Tutorial](../user_guide/tutorial.qmd).
