...
def test_back_to_back_no_leakage(back_to_back_no_leakage):
    ...
    assert_allclose(p0r.suc.p(), 708300)
    assert_allclose(p0r.head, 42576.684726, rtol=1e-6)
    assert_allclose(p0r.casing_heat_loss, 1787.346)
    assert_allclose(p0r.eff, 0.627698, rtol=1e-6)
    ...
    assert_allclose(p0r.head, 12411.07461, rtol=1e-6)
    assert_allclose(p0r.casing_heat_loss, 1344.156)
    assert_allclose(p0r.eff, 0.474668, rtol=1e-6)
    assert_allclose(p0r.power, 128825.607976)

    # rotor specified sec2
    p0r = back_to_back.points_rotor_sp_sec2[0]
    assert_allclose(p0r.flow_v.to("m³/h"), 1147.528911)
    assert_allclose(p0r.flow_m, 52.224884, rtol=1e-4)
    assert_allclose(p0r.suc.T(), 313.15)
    assert_allclose(p0r.suc.p(), 13197135.438141, rtol=1e-5)
    assert_allclose(p0r.head, 30603.247711, rtol=1e-6)
    assert_allclose(p0r.eff, 0.474668, rtol=1e-6)
    assert_allclose(p0r.power, 3367094.04496, rtol=1e-4)

    # flange specified sec2
    p0f_sp = back_to_back.points_flange_sp_sec2[0]
    assert_allclose(p0f_sp.flow_m, 52.224884, rtol=1e-4)
    assert_allclose(p0f_sp.suc.T(), 313.15)
    assert_allclose(p0f_sp.suc.p(), 13197135.438141, rtol=1e-5)
    assert_allclose(p0f_sp.head, 30603.247711, rtol=1e-6)
    assert_allclose(p0f_sp.eff, 0.474668, rtol=1e-6)
    assert_allclose(p0f_sp.power, 3367094.04496, 1e-4)
    ...
    assert_allclose(p0r_sp.suc.p(), 4739000)
    assert_allclose(p0r_sp.disch.T(), 380.429963, rtol=1e-5)
    assert_allclose(p0r_sp.head, 77214.966583, rtol=1e-6)
    assert_allclose(p0r_sp.eff, 0.627698, rtol=1e-6)
    ...
    assert_allclose(p0f_sp.suc.T(), 313.15, rtol=1e-3)
    assert_allclose(p0f_sp.suc.p(), 4739000)
    assert_allclose(p0f_sp.disch.T(), 380.429963, rtol=1e-5)
    assert_allclose(p0f_sp.head, 77214.967053, rtol=1e-6)
    assert_allclose(p0f_sp.eff, 0.627698, rtol=1e-6)
    ...
    assert_allclose(p0f_sp.suc.T(), 313.15)
    assert_allclose(p0f_sp.suc.p(), 13197135.438141, rtol=1e-5)
    assert_allclose(p0f_sp.head, 30596.385467, rtol=1e-4)
    assert_allclose(p0f_sp.eff, 0.476274, rtol=1e-4)
    # power in this case is the 'real' power consumed by the rotor
    assert_allclose(p0f_sp.power, 3410709.323526, 1e-4)
