...
def curve0():
    ...
    disch1 = State.define(p=Q_(2.5, "bar"), T=375, fluid={"co2": 1 - 1e-15, "n2": 1e-15})
...
def curve1():
    ...
    disch = State.define(p=Q_(2, "bar"), T=370, fluid={"co2": 1 - 1e-15, "n2": 1e-15})
    disch1 = State.define(p=Q_(2.5, "bar"), T=375, fluid={"co2": 1 - 1e-15, "n2": 1e-15})
    disch2 = State.define(p=Q_(2.6, "bar"), T=376, fluid={"co2": 1 - 1e-15, "n2": 1e-15})
    disch3 = State.define(p=Q_(2.7, "bar"), T=377, fluid={"co2": 1 - 1e-15, "n2": 1e-15})
    p0 = Point(suc=suc, disch=disch, flow_v=1, speed=1)
    p1 = Point(suc=suc, disch=disch1, flow_v=2, speed=1)
