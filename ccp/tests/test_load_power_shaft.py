...
def test_load_power_shaft(suc_0, test_point_0):
    ...
    assert_allclose(test_point_0.disch.T().to("degC").m, 189.5, atol=1.3)

    assert_allclose(test_point_0.power.to("kW").m, 10290, atol=41)
    assert_allclose(test_point_0.power_shaft.to("kW").m, 10394, atol=43)
    ...
    assert_allclose(test_point_0.torque.to("N*m").m, 7457, atol=31)
